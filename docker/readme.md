...
### Build for Current Version (0.3.5)
...
docker tag saigeqtl wzhou88/saigeqtl:0.3.5
docker tag saigeqtl wzhou88/saigeqtl:latest

# Push both tags to Docker Hub
docker push wzhou88/saigeqtl:0.3.5
...
docker run --rm wzhou88/saigeqtl:0.3.5 step1_fitNULLGLMM_qtl.R --help
...
- `wzhou88/saigeqtl:0.3.5` - Specific version 0.3.5 (current stable, adds --solverMethod flag)
